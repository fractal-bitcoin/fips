...
![[fip-102-pie-allocation-dark (1).png]]
...
From August 9 through August 18, 2026, the proposal will remain open for community discussion and feedback. The Fractal Team will continue refining the proposal and its implementation details in response to that feedback, with the aim of finalizing FIP-102 by August 18.

### 7.3 Publish the New Indexer Version

On August 9, 2026, the Fractal Team will publish a new indexer version in preparation for the halving and FIP-102 activation.
...
### 7.7 Progressively Launch Bitcoin-Mainnet Distribution

The Fractal block-reward change must take effect at block 2,100,000, but the Bitcoin-mainnet distribution path cannot necessarily become fully operational at the same moment. Additional preparation is required on the Bitcoin side, so distribution to Bitcoin-mainnet users is expected to begin after activation and roll out progressively over approximately three months.

For the purpose of FIP-102, this transition should be understood as moving the Bitcoin-mainnet distribution path back and phasing it in over the rollout period. It does not change the maximum FB supply, create a separate Bitcoin-mainnet supply, or change the 6.25 FB-per-Fractal-block target allocation. Once the rollout reaches 100%, Bitcoin-mainnet distribution will operate at the full target rate of 6.25 FB per Fractal block equivalent.

The exact rollout schedule, distribution mechanics, and treatment of the Bitcoin-mainnet allocation during the transition will be defined in FIP-103.
